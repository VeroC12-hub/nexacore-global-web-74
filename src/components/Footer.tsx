        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3 pt-2">
              ...
              <a href="https://www.youtube.com/@NexaCoreInnovations" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://x.com/nexacoreinno?s=21&t=r5P_NA_hBu9tDjZkiMMBQQ" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://t.me/nexacoreinnovations" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.tiktok.com/@nexacore.innovations?_t=ZM-8zDYXzpzJmo&_r=1" target="_blank" rel="noopener noreferrer"
