...
export function ERPOverviewTab({ 
  ...
  const performVoiceSearch = useCallback((query: string) => {
    ...
    setTimeout(() => {
      ...
      addSearchToHistory(query, results.length, { tab: 'overview' });
    }, 100);
  }, [searchableData]);
  ...
  const quickActions = [
    ...
    { id: 'create-invoice', label: 'Create Invoice', icon: FileText, color: 'bg-purple-500 hover:bg-purple-600', description: 'Generate a new invoice' },
