...
import { TimeEntryExport } from './TimeEntryExport';
...
export function ERPTimeTab({
  ...
  // Get unique users for export
  const uniqueUsers = Array.from(new Set(timeEntries.map(e => ({
    id: e.user_id,
    name: e.user_name
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Time Entries Management with Tabs */}
                              ...
                              <UITooltip>
                                <TooltipTrigger asChild>
                                  <Button
                                    variant="outline"
                                    size="sm"
                                    onClick={() => onDeleteTimeEntry(entry)}
                                ...
                                <TooltipContent>
                                  <p className="font-medium text-red-600">Delete Time Entry</p>
                                  <p className="text-xs text-muted-foreground">Remove this time entry</p>
                                </TooltipContent>
                              </UITooltip>
