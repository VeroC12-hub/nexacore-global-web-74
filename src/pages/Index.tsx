  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <SEO
        ...
        description="Leading provider of CAD design, software development, AI/ML, blockchain, and digital solutions. Delivering world-class technical, creative, and digital services worldwide."
