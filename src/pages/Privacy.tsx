...
import { Shield, Mail, Phone, MapPin, ChevronRight, ExternalLink } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              This Privacy Statement explains how we collect, use, and disclose your personal information when you use our services
            </p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div id="introduction" className="mb-12">
              <h2 className="text-3xl font-bold mb-6">Privacy Statement</h2>
              <div className="space-y-4 text-base leading-relaxed">
                <p>
                  ...
                  or anywhere we display or reference this Privacy Statement. It also explains what privacy rights you have and how to exercise them.
                </p>
                <p>
                  Certain functionalities or services that are part of the NexaCore service may also provide you with contextual 
                  privacy information or choices, in addition to the information and choices described in this Privacy Statement. 
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-muted/20 rounded-lg p-6 border-l-4 border-primary/30">
                      ...
                      <ul className="list-disc list-inside mt-3 space-y-1 text-muted-foreground text-base">
                        ...
                        <li>Device and software characteristics (such as type and configuration), referring source (for example, referrer URLs), standard web browser and application log information, and connection information including type (such as wifi or cellular)</li>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border rounded-lg p-6">
                      ...
                      <p className="text-muted-foreground text-base leading-relaxed">
                        ...
                        and device and network information. The categories of personal information that Partners provide to us will vary depending 
                        on the nature of the Partner and your relationship with them. Our Partners may include:
                      </p>
                      <ul className="list-disc list-inside mt-3 space-y-1 text-muted-foreground text-base">
                    ...
                    <div className="border rounded-lg p-6">
                      ...
                      <p className="text-muted-foreground text-base leading-relaxed">
                        ...
                        business information, and device and network information. These sources include Service Providers, NexaCore Marketing Providers, 
                        third-party sites and forums, publicly available sources, and other information providers.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse border border-muted rounded-lg text-sm">
                      ...
                      <tbody>
                        {[
                          {
                            purpose: "To provide our engineering, software development, design, and analytics services including delivering personalized recommendations and solutions",
                            categories: "Personal details, NexaCore account/service information, project and service information, business information, usage information, device and network information, communications",
                            legal: "Performance of contract, legitimate interests"
                          },
                          {
                            purpose: "To administer and operate our business including processing payments, sending transactional communications, managing project deliverables",
                            categories: "Personal details, payment details, project and service information, NexaCore account/service information, usage information, device and network information, communications",
                            legal: "Performance of contract, legitimate interests"
                          },
                          {
                            purpose: "To research, analyze, and improve our services such as analyzing and understanding our clients to improve our services",
                            categories: "Personal details, payment details, project and service information, NexaCore account/service information, business information, usage information, device and network information, communications",
                            legal: "Legitimate interests, consent"
                          },
                          {
                            purpose: "To enable Partner integrations and collaborations so that our Partners can facilitate service delivery",
                            categories: "Personal details, payment details, NexaCore account/service information, business information, usage information, device and network information, communications",
                            legal: "Performance of contract, legitimate interests"
                          },
                          {
                            purpose: "To send marketing and informational messages including news and promotional communications about our services",
                            categories: "Personal details, NexaCore account/service information, project and service information, business information, usage information, device and network information, communications",
                            legal: "Legitimate interests, consent"
                          },
                          {
                            purpose: "For safety, security, and fraud prevention including securing our systems and protecting our business",
                            categories: "Personal details, payment details, NexaCore account/service information, usage information, device and network information, communications",
                            legal: "Legitimate interests, legal compliance"
                          },
                          {
                            purpose: "To comply with law and enforce the NexaCore Terms of Use including satisfying applicable law and regulation",
                            categories: "Personal details, payment details, NexaCore account/service information, project and service information, usage information, device and network information, communications",
                            legal: "Legal compliance, legitimate interests"
                          }
                        ].map((row, index) => (
                          <tr key={index} className="hover:bg-muted/20">
                            <td className="border border-muted p-4 text-base">{row.purpose}</td>
                            <td className="border border-muted p-4 text-base">{row.categories}</td>
                            <td className="border border-muted p-4 text-base">{row.legal}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-muted/20 rounded-lg p-6">
                  ...
                  <p className="text-muted-foreground text-base leading-relaxed mb-4">
                    Your project data, files, and related information are accessible to team members you designate and NexaCore personnel involved in 
                    service delivery. When you use collaborative features of our service, information you share may be visible to other designated participants.
                  </p>
                  <p className="text-muted-foreground text-base leading-relaxed">
                    Please note that project information, recommendations, and similar information may be made available through various features and 
                    user experiences, such as Partner interfaces that are integrated with the NexaCore service.
                  </p>
                </div>
                ...
                <div className="bg-muted/20 rounded-lg p-6">
                  ...
                  <p className="text-muted-foreground text-base leading-relaxed">
                    ...
                    locate the "Security Settings" option, and follow the instructions to sign out of your devices. Users of public or shared devices 
                    should log out at the completion of each session. If you sell or return a device, be sure to first log out of your NexaCore account.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="mb-6 text-base leading-relaxed">
                    ...
                    This section explains the types of technologies used, what they do, and your corresponding choices.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Small data files stored on your device when you access websites and online services. We also use browser storage and plugins 
                        (HTML5, IndexedDB, WebSQL) which work similarly to cookies.
                      </p>
                    </div>
                    <div className="border rounded-lg p-4">
                      <h4 className="font-semibold mb-2">Pixel Tags</h4>
                      <p className="text-sm text-muted-foreground">
                        Often work in conjunction with cookies to measure and improve our services. We use pixel tags in our emails to understand 
                        how members interact with our service.
                      </p>
                    </div>
                    <div className="border rounded-lg p-4">
                    ...
                    <div className="border rounded-lg p-4">
                      <h4 className="font-semibold mb-2">Device Identifiers</h4>
                      <p className="text-sm text-muted-foreground">
                        Resettable device identifiers found on mobile devices and tablets (such as "Identifier for Advertisers" on Apple iOS devices 
                        and "Google Advertising ID" on Android devices).
                      </p>
                    </div>
                  </div>
                </div>
                        ...
                        {[
                          {
                            ...
                            description: "Making it easy to access our service by remembering you when you return",
                            tech: "Cookies, local storage"
                          },
                          {
                            purpose: "Service Delivery",
                            description: "Providing core functionality and personalized experiences",
                            tech: "Cookies, pixel tags, local storage"
                          },
                          {
                            purpose: "Analytics and Improvement",
                            description: "Understanding how our service is used and improving performance",
                            tech: "Cookies, pixel tags, analytics identifiers"
                          },
                          {
                            purpose: "Marketing and Communication",
                            description: "Delivering and measuring effectiveness of marketing communications",
                            tech: "Cookies, pixel tags, hashed identifiers"
                          },
                          {
                            purpose: "Security and Fraud Prevention",
                            description: "Protecting our service and users from security threats",
                            tech: "Cookies, device identifiers"
                          }
                        ].map((row, index) => (
                          <tr key={index} className="hover:bg-muted/20">
                            <td className="border border-muted p-3 font-medium">{row.purpose}</td>
                            <td className="border border-muted p-3">{row.description}</td>
                            <td className="border border-muted p-3">{row.tech}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  ...
                  <div className="space-y-6">
                    <div className="bg-primary/5 rounded-lg p-6">
                      ...
                      <p className="text-muted-foreground text-base leading-relaxed">
                        ...
                        nexacore-innovations.com/cookies. We do not currently respond to web browser "do not track" signals.
                      </p>
                    </div>
                    ...
                    <div className="bg-primary/5 rounded-lg p-6">
                      ...
                      <p className="text-muted-foreground text-base leading-relaxed">
                        For mobile devices, you can control advertising identifiers in your device's privacy settings (usually found under "privacy" or "ads").
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div id="section-e" className="mb-12">
              ...
              <div className="space-y-10">
                ...
                <div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse border border-muted rounded-lg text-sm">
                      ...
                      <tbody>
                        {[
                          { type: "Account Information", period: "Duration of service relationship plus 7 years", purpose: "Service delivery, legal compliance" },
                          { type: "Project Files and Deliverables", period: "10 years from project completion", purpose: "Client access, legal protection" },
                          { type: "Financial Records", period: "7 years from transaction date", purpose: "Tax compliance, auditing" },
                          { type: "Marketing Data", period: "Until opt-out or 3 years of inactivity", purpose: "Marketing communications" },
                          { type: "Usage Analytics", period: "26 months from collection", purpose: "Service improvement" },
                          { type: "Support Communications", period: "3 years from last contact", purpose: "Customer service, quality assurance" }
                        ].map((item, index) => (
                          <tr key={index} className="hover:bg-muted/20">
                            <td className="border border-muted p-3 font-medium">{item.type}</td>
                            <td className="border border-muted p-3">{item.period}</td>
                            <td className="border border-muted p-3">{item.purpose}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-6">E4. Children's Privacy</h3>
                  <p className="text-base leading-relaxed">
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="border rounded-lg p-6">
                      <h4 className="font-semibold text-lg mb-3">EU/UK Residents (GDPR)</h4>
                      <p className="text-sm text-muted-foreground mb-3">
                        <strong>Legal Basis for Processing:</strong> We process your personal data based on performance of contract, 
                        legitimate business interests, your consent, and legal compliance requirements.
                      </p>
                      <p className="text-sm text-muted-foreground mb-3">
                        <strong>Additional Rights:</strong> Data portability, right to restrict processing, right to object to processing 
                        based on legitimate interests, and right to lodge complaints with data protection authorities.
                      </p>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="border rounded-lg p-6">
                      <h4 className="font-semibold text-lg mb-3">California Residents (CCPA)</h4>
                      <p className="text-sm text-muted-foreground mb-3">
            ...
            {/* Contact Information */}
            <div id="contact-info" className="mt-12 bg-primary/5 rounded-2xl p-8">
              ...
              <div className="mt-6 pt-6 border-t border-primary/20">
                <h3 className="font-semibold mb-3">Governing Law and Language</h3>
